    ...
    <>
      ...
      <section ref={sectionRef} className="bg-white p-6 md:p-10 lg:p-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          >
            <h1 className="flex justify-center text-3xl md:text-4xl font-bold text-[#311d09] tracking-wider mb-4">
              Vision
            </h1>
            <p className="text-sm md:text-base text-[#a4907c] max-w-prose mx-auto md:mx-0 mt-5 mb-5">
          ...
          >
            <img
              src="/images/about/3000x2000.png"
              alt="Vision Image"
      ...
      <section className="bg-gray-50 p-6 md:p-10 lg:p-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6">
          <div className="flex-1 bg-white bg-opacity-90 p-6 rounded-lg shadow-lg floating-box">
            <h2 className="flex justify-center text-xl font-semibold mb-3 text-[#311d09]">
              Quality Policy
            </h2>
            <p className="text-[#6b5840] text-sm md:text-base leading-relaxed">
